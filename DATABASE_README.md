...
### 11. PATIENT BILLS TABLE (`patientBills`)
**Purpose**: Generated bills for patients
```sql
CREATE TABLE patientBills (
  id INT PRIMARY KEY AUTO_INCREMENT,
  invoiceNumber VARCHAR(255) NOT NULL,
  billData TEXT, -- JSON object with bill details
  clinicId INT NOT NULL,
  patientId INT NOT NULL,
  createdAt TIMESTAMP,
  updatedAt TIMESTAMP,
...
### 22. DAILY ACTIVITIES TABLE (`dailyActivities`)
**Purpose**: Track user daily activities
```sql
...
### 23. SCHEDULE CRON TABLE (`scheduleCrons`)
**Purpose**: Scheduled appointment reminders
```sql
CREATE TABLE scheduleCrons (
  id INT PRIMARY KEY AUTO_INCREMENT,
